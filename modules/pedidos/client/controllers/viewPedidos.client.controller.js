angular.module('pedidos').controller('ViewPedidosController', ['$scope', '$rootScope', '$stateParams', '$location', 'Authentication', 'Pedidos', 'Enterprises', '$mdBottomSheet', '$state', '$mdDialog', 'pedidos', 'tipoOrden', 'tipoPedido', 'Products', 'Providers' ,  'Condicionventas', 'Cajas',
    function ($scope, $rootScope, $stateParams, $location, Authentication, Pedidos, Enterprises, $mdBottomSheet, $state, $mdDialog, pedidos, tipoOrden, tipoPedido, Products,Providers, Condicionventas, Cajas) {
        ...
        $scope.editProducto = function (p, pedido, index) {
            ...
            pedido.totalTax = iva;
            pedido.total = pedido.subtotal + iva;
        ...
        $scope.sumarProductoCompra = function (producto, productoPedido, pedido) {
            ...
            if (producto !== undefined) {
                if (productoPedido !== undefined) {
                    ...
                    Providers.get({ providerId: producto.provider[0].id }, function(prov){
                        

                        var impuestos = prov.impuesto1 + prov.impuesto2 + prov.impuesto3 + prov.impuesto4;
