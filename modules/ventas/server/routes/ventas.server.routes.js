...
module.exports = function(app) {
	...
	app.route('/api/ventas/loadmoreByCaja').all(ventasPolicy.isAllowed)
		.get(ventas.loadMoreByCaja);		

	app.route('/api/ventas/loadmoreByCaja_Date').all()
		.get(ventas.loadmoreByCaja_Date);
