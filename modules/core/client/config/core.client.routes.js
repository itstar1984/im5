...
angular.module('core').config(['$stateProvider', '$urlRouterProvider',
    function($stateProvider, $urlRouterProvider, $scope) {
        ...
        .state('home.procedimientos', {
            ...
            .state('home.detailsPresentacion', {
                url: 'impuestos/detailspresentacion/{impuestosId}',
                titulo: 'Detalle de Presen',
                prevState: 'home.viewImpuesto',
                controller: 'ImpuestosPresentacionController',
                controllerAs: 'ctrl',
                templateUrl: 'modules/impuestos/views/presentacion-impuesto.client.view.html'
            })
