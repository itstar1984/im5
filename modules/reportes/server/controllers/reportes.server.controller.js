...
exports.reporteVentaPorRange = function(req, res) {
    ...
    var clients = req.query.client || null;
    if (enterprise === null) {
        return res.status(400).send({ message: 'You must specify the enterprise first' });
    }
    ...
    Venta.find({ enterprise: enterprise, 'created': { $gte: startDate, $lte: endDate }, estado: 'Finalizada' })
    .populate('product')
    .populate('cliente')
    .exec(function(err,result){
            if (err) {
            ...
            result.forEach(function(entry) {
                ...
                if (entry.products.length > 1) {
                    entry.products.forEach(function(product) {
                        ...
                        if(clients)
                        {
                            if(_.findIndex(returnData.byClients,{id:entry.cliente._id}) === -1)
                            {
                                returnData.byClients.push({
                                    id:entry.cliente._id,
                                    name:entry.cliente.name,
                                    total:product.total,
                                    cantidad:product.cantidad
                                })
                            }
                            ...
                            {
                                returnData.byClients[_.findIndex(returnData.byClients,{id:entry.cliente._id})].total +=product.total;
                                returnData.byClients[_.findIndex(returnData.byClients,{id:entry.cliente._id})].cantidad += product.cantidad; 
                            }
                        }
                    })
                } else {
                     ...
                     if(clients)
                    {
                        ...
                        {
                            returnData.byClients[_.findIndex(returnData.byClients,{id:entry.cliente._id})].total +=entry.products[0].total;
                            returnData.byClients[_.findIndex(returnData.byClients,{id:entry.cliente._id})].cantidad += entry.products[0].cantidad; 
                        }
                    }
                }
                ...
                if (!entry.puesto) {
                    if (_.findIndex(returnData.byPuesto, { from: "others" }) === -1) {
                        returnData.byPuesto.push({ from: "others", total: entry.total, byCategory: [], byProduct: [],byClients:[] });
                    ...
                    if (entry.products.length > 1) {
                        entry.products.forEach(function(product) {
                            ...
                            if(clients)
                            {
                                if(_.findIndex(returnData.byPuesto[_.findIndex(returnData.byPuesto,{from:"others"})].byClients,{id:entry.cliente._id}) === -1)
                                {
                                    returnData.byPuesto[_.findIndex(returnData.byPuesto,{from:"others"})].byClients.push({
                                        id:entry.cliente._id,
                                        name:entry.cliente.name,
                                        total:product.total,
                                        cantidad:product.cantidad
                                ...
                                {
                                    returnData.byPuesto[_.findIndex(returnData.byPuesto,{from:"others"})].byClients[_.findIndex(returnData.byClients,{id:entry.cliente._id})].total +=product.total;
                                    returnData.byPuesto[_.findIndex(returnData.byPuesto,{from:"others"})].byClients[_.findIndex(returnData.byClients,{id:entry.cliente._id})].cantidad +=product.cantidad; 
                                }
                            }
                        })
                    } else {
                        ...
                        if(clients)
                        {
                            ...
                            {
                                returnData.byPuesto[_.findIndex(returnData.byPuesto,{from:"others"})].byClients[_.findIndex(returnData.byClients,{id:entry.cliente._id})].total +=entry.products[0].total;
                                returnData.byPuesto[_.findIndex(returnData.byPuesto,{from:"others"})].byClients[_.findIndex(returnData.byClients,{id:entry.cliente._id})].cantidad +=entry.products[0].cantidad; 
                            }
                        }
                    }
                } else {
                    ...
                    if (entry.products.length > 1) {
                        entry.products.forEach(function(product) {
                           ...
                           if(clients)
                            {
                                if(_.findIndex(returnData.byPuesto[_.findIndex(returnData.byPuesto,{from:entry.puesto})].byClients,{id:entry.cliente._id}) === -1)
                               {
                                    returnData.byPuesto[_.findIndex(returnData.byPuesto,{from:entry.puesto})].byClients.push({
                                        id:entry.cliente._id,
                                        name:entry.cliente.name,
                                        total:product.total,
                                        cantidad:product.cantidad
                                ...
                                {
                                    returnData.byPuesto[_.findIndex(returnData.byPuesto,{from:entry.puesto})].byClients[_.findIndex(returnData.byPuesto[_.findIndex(returnData.byPuesto,{from:entry.puesto})].byClients,{id:entry.cliente._id})].total += product.total;
                                    returnData.byPuesto[_.findIndex(returnData.byPuesto,{from:entry.puesto})].byClients[_.findIndex(returnData.byPuesto[_.findIndex(returnData.byPuesto,{from:entry.puesto})].byClients,{id:entry.cliente._id})].cantidad += product.cantidad;
                                }
                            }
                        })
                    } else {
                        ...
                        if(clients)
                        {
                            ...
                            {
                                returnData.byPuesto[_.findIndex(returnData.byPuesto,{from:entry.puesto})].byClients[_.findIndex(returnData.byPuesto[_.findIndex(returnData.byPuesto,{from:entry.puesto})].byClients,{id:entry.cliente._id})].total += entry.products[0].total;
                                returnData.byPuesto[_.findIndex(returnData.byPuesto,{from:entry.puesto})].byClients[_.findIndex(returnData.byPuesto[_.findIndex(returnData.byPuesto,{from:entry.puesto})].byClients,{id:entry.cliente._id})].cantidad += entry.products[0].cantidad;
                            }
                        }
                    }
                }
            ...
            returnData.byClients = _.sortBy(returnData.byClients, ['total']).reverse();
            ...
            returnData.byClients.forEach(function(entry) {
                entry.percent = (entry.total / returnData.balance) * 100
            })
            ...
            returnData.byPuesto.forEach(function(puesto) {
                ...
                puesto.byClients = _.sortBy(puesto.byClients, ['total']).reverse();
                ...
                puesto.byClients.forEach(function(entry) {
                    entry.percent = (entry.total / puesto.total) * 100
                })
            });
...
exports.reporteCompraPorRange = function(req, res) {
    ...
    var category = req.query.category || null;
    var products = req.query.products || null;
    var clients = req.query.clients || null;
    if (enterprise === null) {
        return res.status(400).send({ message: 'You must specify the enterprise first' });
    }
        ...
        .exec(function(err, result) {
            ...
            result.forEach(function(entry) {
                ...
                entry.products.forEach(function(product) {
                    ...
                    if (clients) {
                        if (_.findIndex(returnData.byClients, { id: entry.proveedor._id }) === -1) {
                            returnData.byClients.push({
                                id:entry.proveedor._id,
                                name: entry.proveedor.name,
                                total: product.total,
                                cantidad: product.cantidad
                            })
                        } else {
                            returnData.byClients[_.findIndex(returnData.byClients, { id:entry.proveedor._id })].total += product.total;
                            returnData.byClients[_.findIndex(returnData.byClients, { id:entry.proveedor._id })].cantidad += product.cantidad;
                        }
                    }
                    ...
                    if (!entry.puesto) {
                        ...
                        if(clients)
                        {
                            if (_.findIndex(returnData.byPuesto[_.findIndex(returnData.byPuesto, { from: "others" })].byClients, { id: entry.proveedor._id }) === -1) {
                                returnData.byPuesto[_.findIndex(returnData.byPuesto, { from: "others" })].byClients.push({
                                    id:entry.proveedor._id,
                                    name: entry.proveedor.name,
                                    total: product.total,
                                ...
                                returnData.byPuesto[_.findIndex(returnData.byPuesto, { from: "others" })].byClients[_.findIndex(returnData.byPuesto[_.findIndex(returnData.byPuesto, { from: "others" })].byClients, { name: product.product.name })].total += product.total;
                                returnData.byPuesto[_.findIndex(returnData.byPuesto, { from: "others" })].byClients[_.findIndex(returnData.byPuesto[_.findIndex(returnData.byPuesto, { from: "others" })].byClients, { name: product.product.name })].cantidad += product.cantidad;
                            }
                        }
                    } else {
                        if (category) {
                        ...
                        if (clients) {
                            if (_.findIndex(returnData.byPuesto[_.findIndex(returnData.byPuesto, { from: entry.puesto })].byClients, { id: entry.proveedor._id }) === -1) {
                                returnData.byPuesto[_.findIndex(returnData.byPuesto, { from: entry.puesto })].byClients.push({
                                    id:entry.proveedor._id,
                                    name: entry.proveedor.name,
                                    total: product.total,
                                ...
                                returnData.byPuesto[_.findIndex(returnData.byPuesto, { from: entry.puesto })].byClients[_.findIndex(returnData.byPuesto[_.findIndex(returnData.byPuesto, { from: entry.puesto })].byClients, { id: entry.proveedor._id })].total += product.total;
                                returnData.byPuesto[_.findIndex(returnData.byPuesto, { from: entry.puesto })].byClients[_.findIndex(returnData.byPuesto[_.findIndex(returnData.byPuesto, { from: entry.puesto })].byClients, { id: entry.proveedor._id })].cantidad += product.cantidad;
                            }
                        }
                    }
                })
...
exports.reporteCompraPorMonthDetailed = function(req, res) {
    ...
    if(month) {
        var splitStr = month.split('-');
        startDate = Moment().year(splitStr[0]).month(splitStr[1]).startOf("month");
        endDate = startDate.clone().endOf('month');
    }


    //Compra.find({ enterprise: enterprise, 'filterDate.month': month, estado: 'Finalizada' })
    Compra.find({ enterprise: enterprise, fechaRecepcion: {
                $gt: startDate.format(),
                $lt: endDate.format()
            }, estado: 'Finalizada' })
        .populate('product')
...
exports.reporteVentacategoriasPorDay = function(req, res) {
    ...
    Venta.aggregate(
        ...
        .cursor({batchSize:1000})
         .exec(function(err, result) {
            if (err) {
                console.log('[-] Reportes::asaaaareportePorQ::venta.aggregate::error:', err);
                return res.status(400).send({
                    message: errorHandler.getErrorMessage(err)
                });
            }
