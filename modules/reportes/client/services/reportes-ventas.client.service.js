...
angular.module('reportes').factory('ReportesVentas', ['$http',
    function($http) {
        return {
            ...
            getDataDetailedMonth: function(month, enterprise, category, products,client,costcenter) {
                return $http({
                    method: "get",
            ...
            getDataWeek: function(week, enterprise, category, products,client,costcenter) {
                return $http({
                    method: "get",
            ...
            getDataDay: function(day, enterprise, category, products,client,costcenter) {
                return $http({
                    method: "get",
            ...
            getDataRange: function(start, end, enterprise, category, products,client,costcenter) {
                return $http({
                    method: "get",
