...
angular.module('sucursales').controller('SucursalesListController', ['$location', 'user', 'sucursales', 'enterprises', '$mdDialog', 'cajas', 'ServiceNavigation','$rootScope',
    function($location, user, sucursales, enterprises, $mdDialog, cajas, ServiceNavigation,$rootScope) {
