	...
	client: {
		lib: {
			...
			js: [
				...
				'public/lib/quick-ng-repeat/quick-ng-repeat.js',
				'public/lib/ng-webworker/src/ng-webworker.js',
				...
				'public/lib/angular-file-upload/angular-file-upload.min.js',
				'http://maps.google.com/maps/api/js?key=AIzaSyDLJQpmgGB9U3FF21rf_pnjXafz0Ja8CSY&libraries=places',
